...
urlpatterns += [
    path('bookinstance/<int:pk>/update/', views.BookInstanceUpdate.as_view(), name='bookinstance-update'), # from catalog app
    path('bookinstance/<int:pk>/delete/', views.BookInstanceDelete.as_view(), name='bookinstance-delete'), # from catalog app
]
