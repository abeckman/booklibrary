...
# The following came from Perplexity.ai
# Used by DEBUG
...
import os # orig
import sys # needed for fontawesomefree

sys.modules['fontawesomefree'] = __import__('fontawesomefree')

# Build paths inside the project like this: BASE_DIR / 'subdir'.
#BASE_DIR = Path(__file__).resolve().parent.parent # orig
...
#INTERNAL_IPS = ('HTTP_X_REAL_IP') # over ridden below
...
MIDDLEWARE = [
    ...
    'django.middleware.clickjacking.XFrameOptionsMiddleware', # first 7 are orig
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, "templates")], # was 'DIRS': [],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                'django.template.context_processors.request',
                'django.contrib.auth.context_processors.auth',
                'django.contrib.messages.context_processors.messages', # above orig
...
WSGI_APPLICATION = 'library.wsgi.application' # orig
...
"""
# Much of the commented out code comes from a Coursera course
# Sessions
...
TIME_ZONE = "UTC"
USE_I18N = True
USE_L10N = True # not in 6.0
USE_TZ = True

# Static files (CSS, JavaScript, Images)
# https://docs.djangoproject.com/en/6.0/howto/static-files/
STATIC_URL = "/static/" # from orig
